...
define('view/Basic',['Backbone', 'handlebars', 'target/templates'], function (Backbone, Handlebars) {
...
define('view/Head',['view/Basic'],
    function (Basic) {
        return Basic.extend({ name: 'Head' });
    }
);

define('view/SingleColumnTemplate',['view/Basic'],
    function (Basic) {
        return Basic.extend({ name: 'SingleColumnTemplate' });
    }
);

define('view/SiteHeader',['view/Basic'], function (Basic) {
        return Basic.extend({ name: 'SiteHeader' });
    }
);
define('view/Greeting',['view/Basic'], function (Basic) {
        return Basic.extend({ name: 'Greeting' });
    }
);

define('view/TvFinder',[
    'jQuery',
    'Backbone',
    'view/Head',
